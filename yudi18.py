...
cl = VIPRO.LINE()
cl.login(token="EtfznMzOZL76EBL0Z3H2.AZs3a8Vf+ipnhLTOmQbtuG.wuogaSeLZfvTyRNjBiA7maO9Q1ssEGTYt4I2WjOtC3I=")
cl.loginResult()

ki = VIPRO.LINE()
ki.login(token="EtMJ5XdiHLJ22DsHMXs8.BQIP++PfVBkYt2USSm1tMa.UJOOqGQayalATNQADFTELlP9tqa7v/0GaSC4465GKPw=")
ki.loginResult()

kk = VIPRO.LINE()
kk.login(token="EtUs0tnBPMxIbuSiWaL4.bOiJimUzjLhiapSWdVjeva.ktiaY1w0TqQAyCp7r4V1ktD8f1wd5tIHMScefsVgZnU=")
kk.loginResult()

kc = VIPRO.LINE()
kc.login(token="EtAonT0YgCpswd0UqZbb.DQKC4akNYSJx6AqIuzyS6W.8Jw5b/VT6Dt+xUuPfvNONp52njMm3GAOWXT1W50p674=")
kc.loginResult()

kd = VIPRO.LINE()
kd.login(token="EtsgrIlBbnxQjghUA7r5.s0GaOrjP6Vfn98NxODhvLq.JE1rl6HbVla4bmGOqn+Ac0zafquCN+9X5EQcykDpoOE=")
kd.loginResult()

ke = VIPRO.LINE()
ke.login(token="EtrHmWx8P23HpfRnAZq1.hSPlQK0sOlldo8W2iFcJWq.TSfTZ0uloPcUxYRpOZuBn+nEAdaMQj1nDRnLF/KFm0M=")
ke.loginResult()

kf = VIPRO.LINE()
kf.login(token="EtCtE5eVAWgSflZYlinb.laBbOEpcsXIXQThDvNl//W.ISsDvhpdxP8HwZRbKuTokvfarSwKDIsWTSYLoJr0sYY=")
kf.loginResult()

kg = VIPRO.LINE()
kg.login(token="EtU9gnLJdLIw0DNVRzk3.eXGEKA8y87MQtoFvPFGwuW.7YllGxcTQEdA8w3P3Fp6XbSSg5hawZLROUyUrC15tFw=")
kg.loginResult()

kh = VIPRO.LINE()
kh.login(token="Etmuakbm8Uq1fRMrrvZ4./0DOo/10A+PUJG8iHA76Pa.g7xkJ92b7s0HPX0wOMVMFpqquWosJmJoslrFj2bx0LI=")
kh.loginResult()

kj = VIPRO.LINE()
kj.login(token="Et91sbY3FlyxwC6nyf0b.drkXjI9kC7gz45kx2rUb2W.B45GK8LeHEhSailVIqKQMdPVP0tCV2+iePjjprOwdok=")
kj.loginResult()

kl = VIPRO.LINE()
kl.login(token="EtNLNTYonZnipkZjHva9.VfG2daMSMKOL78PxRGOi6q.UvEujaL2rfIXM6wo9ujqpQN7IB/ueqsZ14dYem/Z8/U=")
kl.loginResult()

km = VIPRO.LINE()
km.login(token="EtP6IvL4pbTS0UqXml83.Z7tUqKO5oaEP2cnIzYreyW./skjh1WmSIGNl8Uaj7clVzxebafOqTTQGnozr49cIjU=")
km.loginResult()

kn = VIPRO.LINE()
kn.login(token="Etoh4TNizwHkkGUFs6Wc.Ee/eeDlrP0uTdFlXuHf9Na.EWvUWz2ZYHSCh4R/WKN9YSuAl4wNUTFEaB7NqefeSXE=")
kn.loginResult()

ko = VIPRO.LINE()
ko.login(token="EtcHz3QurZHB4NFTvQP9.qMCHtdJp35ezbFZkNZ9z2q.e3RxBBoyvGzZpM8rOZ+MswE7dbtOqdIAO0NwBPgIf8k=")
ko.loginResult()

kp = VIPRO.LINE()
kp.login(token="Etc5PFAng4BxgQyRVXy3.euJAGnAHFMz/2ijo5kdFiW.DauObziUTTkPJyTSvAInDlfKBLh6pG/IlpvX7ULFNGo=")
kp.loginResult()

kq = VIPRO.LINE()
kq.login(token="Et4p2coaZx2aOJ5nOHt6.6CR0ZZsWtgC5MNd6TQcGjG.ssTKPZ7EpxBaR43GPrLCks8bCx13cSmksNXDZ4Am55c=")
kq.loginResult()

kr = VIPRO.LINE()
kr.login(token="EtntgbBYJokiOmRnPyZf.StMJ2yMSv7H5XrT17lGnZW.qgs9lMcbMrbn3fNH/8at6av0Fmlnk+kXXZdYN6i+T3Q=")
kr.loginResult()

ks = VIPRO.LINE()
ks.login(token="EtmQdElCy54gbANAx8De.4uWnRTJU51yT+/CjXTyHBG.lyhGMMKw+9EwWzO8AL1w76r2s12e1QFVaRrrQd0k49o=")
ks.loginResult()
