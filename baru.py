...
#vidia
#kt = VIPRO.LINE()
kt.login(token="EtNObxPwUhlEF1WTDE5e.4uWnRTJU51yT+/CjXTyHBG.ai9QOqjitWSUHWytpqp/vvnS3TwxsPe8PlVvBwnheRc=")
kt.loginResult()
#rosetta
#ks = VIPRO.LINE()
ks.login(token="Et6ryxn0rB1fTfGNJgcf.0Gxc/M3RVqR4nYkPcDjtZW.Xkll2rvg8vUFbMk6qpRWoceqRxdOI0iDl0ur+6X3Oco=")
ks.loginResult()
#sirvelmist
#ki = VIPRO.LINE()
ki.login(token="Etvv8gYEbtnCCqBZRNQ6.u5E0qHumGolsyebggFHFzG.ec3r4QPVpRDOzH0KJCvBAA17bxPvJSv3AFY5aY3FSdc=")
ki.loginResult()
#fawn
#kk = VIPRO.LINE()
kk.login(token="EtsTYlXCYikpZWAegsJa.SD28EqyjtLBjPT144PdcQG.xqJFgw5hzuw8LWKkOxu7S6hy/Y5BrDnmPA1HdG/QfuA=")
kk.loginResult()
#iridessa
#kc = VIPRO.LINE()
kc.login(token="EtoRCJAcOPR55ljziER8.BQIP++PfVBkYt2USSm1tMa.z2Bun2uocA+xtD5MapicqGem+/Ef5jcWhO41ejG7uGQ=")
kc.loginResult()

#kicker ghost
#kl = VIPRO.LINE()
kl.login(token="EtYi5SaWf69VjIB4WWa4.bOiJimUzjLhiapSWdVjeva.sViIOjulyc4xTNADy6yOdWT5+fT1kFVeYMEKjC/6aQk=")
kl.loginResult()
...
helpbot ="""╔═══════════════════
╠❂͜͡➣ Bot1-6 rename:[text]
╠❂͜͡➣ All rename:[text]
╠❂͜͡➣ Allbio:[text]
╠❂͜͡➣ Bot1-6 clone @[name]
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpbot)
             elif msg.text.lower() == 'help group':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,helpgrup)
                else:
                    cl.sendText(msg.to,helpgrup)
             elif msg.text.lower() == 'help owner':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,helpowner)
                else:
                    cl.sendText(msg.to,helpowner)
             elif msg.text.lower() == 'help chat':
                 if wait["lang"] == "JP":
...
#=======================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "b34b703cbc5fc83cd1e5b6832a05352',"}
                cl.sendMessage(msg)
#-----------------=============================   
            elif msg.text in ["Me"]:
	      if msg.from_ in admin:
...
#------------------------_--------------------------------------
            	...
            	if msg.from_ in admin:
             	...
             	if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to,"Title : "+tob+"\nSource : Google Play\nLink ❂͜͡➣ https://play.google.com/store/search?q=" + tob)
                    cl.sendText(msg.to,"「 Mencari 」\n" "Type:Mencari Info\nStatus: Sukses")
...
#-------------------------------------------------
              ...
              if msg.from_ in owner:
					...
					for manusia in n:
						cl.sendText(manusia,(bctxt +"\n\n\nbroadcasted by ❂͜͡➣" + cl.getContact(msg.from_).displayName))
